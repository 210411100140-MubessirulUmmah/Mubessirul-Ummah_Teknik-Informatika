            ...
            if pilihan == 1:
                ...
                if inpaksi == "1":
                    ...
                    try:
                        ...
                        pesan_makanan = {"meja":[meja],"nama": [nama], "makanan": [pilih+" "+jumlah+" bungkus"]}
                        ...
                        print("terjadi kesalahan dalam inputan, silahkan cek kembali pesanan anda")
                        print("silahkan ulangi pemesanan!!!")
                    else:
                        print("pemesanan berhasil, silahkan tunggu pesanan anda:}")
                    finally:
                    ...
                    try:
                        ...
                        pesan_minuman = {"meja":[meja],"nama": [nama], "minuman": [pilih+" "+jumlah+" bungkus"]}
